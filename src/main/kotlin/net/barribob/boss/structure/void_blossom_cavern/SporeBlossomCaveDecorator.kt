...
class SporeBlossomCaveDecorator(private val bottomOfWorld: Int, private val random: Random) : ICaveDecorator {
    ...
    private val sporeBlossom: ConfiguredFeature<*, *> =
        (Feature.SIMPLE_BLOCK.configure(SimpleBlockFeatureConfig(SimpleBlockStateProvider(Blocks.SPORE_BLOSSOM.defaultState)))
            .decorate(
                Decorator.CAVE_SURFACE.configure(
